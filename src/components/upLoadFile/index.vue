<template>
  <label for="uploadFile" @click="clickFile">
    <van-icon name="notes-o" size="20" color="rgba(0, 0, 0, 0.65)" />
    <input ref="imgDom" type="file" class="hide" @change="fileChange">
  </label>
</template>
...
export default {
  ...
  methods: {
    ...
    fileChange(e) {
      const isRoom = this.type === 'chatroom' || this.type === 'groupchat'
