<template>
  <a-modal
    ...
    :footer="null"
  >
    <el-form v-if="showCreateModel == true" :model="form">
      <div>
        <el-input v-model="form.groName" placeholder="群组名称" />
      </div>
      <div class="groDesc">
        <el-input v-model="form.desc" type="textarea" :rows="2" placeholder="简介" />
      </div>
      <div class="groPub">
        <p>群组类型</p>
