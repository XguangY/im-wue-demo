          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  <i class="el-icon-top" @click="openSetAdmin" />
                </el-tooltip>
                ...
                <el-tooltip
                  ...
                  placement="bottom-start"
                >
                  <i class="el-icon-bottom" @click="openRemoveAdmin" />
                </el-tooltip>
                ...
                <el-tooltip
                  ...
                  placement="bottom-start"
                >
                  <i class="el-icon-lock" @click="openSetMute" />
                </el-tooltip>
                ...
                <el-tooltip
                  ...
                  placement="bottom-start"
                >
                  <i class="el-icon-unlock" @click="openRemoveMute" />
                </el-tooltip>

                <!-- 加黑名单 -->
                <el-tooltip class="item" effect="dark" :content="setBlack" placement="bottom-start">
                  <i class="el-icon-warning-outline" @click="openGroupBlack" />
                </el-tooltip>
                ...
                <el-tooltip
                  ...
                  placement="bottom-start"
                >
                  <i class="el-icon-circle-close" @click="openRemoveGroupUser" />
                </el-tooltip>
              </span>
            </div>
